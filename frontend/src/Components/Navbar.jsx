...
const Navbar = () => {
  ...
  return (
    <div className='w-full h-20 flex items-center justify-between px-6 md:px-12 fixed top-0 z-[999] bg-[#fffcfb] shadow-sm'>
        ...
        <div className={`
            ...
            items-center md:w-[45%] h-12 md:h-14 bg-white shadow-lg md:shadow-md rounded-xl border border-gray-100 overflow-hidden transition-all duration-300
        `}>
        ...
        {!isSearchOpen && (
            <div className='flex items-center gap-4 md:gap-6'>
                ...
                <button className='hidden lg:block text-sm font-bold text-gray-700 bg-red-50 px-5 py-2 rounded-full border border-red-100'>
                    My Orders
                </button>
                ...
                <div className='relative'>
                    {userData ? (
                        ...
                        <button onClick={() => navigate("/signin")} className='text-sm font-bold text-[#ff4d2d] hover:underline'>
                            Login
                        </button>
                    )}
                      ...
                      <>
                        ...
                        <div className='absolute top-14 right-0 w-52 bg-white shadow-2xl rounded-2xl p-4 flex flex-col gap-3 border border-gray-50'>
                            ...
                            <nav className='flex flex-col gap-1'>
                              <div className='p-2 hover:bg-gray-50 rounded-lg text-sm font-semibold text-gray-600 cursor-pointer lg:hidden'>My Orders</div>
                              <div className='p-2 hover:bg-gray-50 rounded-lg text-sm font-semibold text-gray-600 cursor-pointer'>Profile Settings</div>
                              <div className='p-2 hover:bg-red-50 rounded-lg text-sm font-bold text-[#ff4d2d] cursor-pointer mt-1' onClick={handleLogout}>
                                Log Out
                              </div>
                            </nav>
                        </div>
